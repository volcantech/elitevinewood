...
export default function Catalog() {
  const [vehicles] = useState<Vehicle[]>(() => loadVehicles());
  ...
  const filteredVehicles = useMemo(() => {
    let filtered = vehicles.filter((vehicle) => {
      ...
      return matchesCategory && matchesSearch && matchesWeight && matchesBudget && matchesSeats;
    });
    ...
    return sorted;
  }, [vehicles, selectedCategory, searchQuery, minWeight, minBudget, maxBudget, selectedSeats, sortBy]);
  ...
  const hasActiveFilters = selectedCategory || minWeight || minBudget > 0 || maxBudget < 15000000 || selectedSeats;

  useEffect(() => {
    setDisplayedCount(VEHICLES_PER_PAGE);
  }, [selectedCategory, searchQuery, minWeight, minBudget, maxBudget, selectedSeats, sortBy]);
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-amber-500/20 rounded-xl p-4 shadow-lg">
                ...
                <select
                  ...
                  onChange={(e) => setSelectedCategory((e.target.value || null) as VehicleCategory | null)}
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-gray-700 border border-gray-600 rounded-lg pl-6 pr-2 py-1.5 text-white text-xs focus:outline-none focus:border-amber-500/50 focus:ring-1 focus:ring-amber-500/20 transition-all"
                    />
                  </div>
                  <div className="relative">
                    <span className="absolute left-2 top-1/2 -translate-y-1/2 text-gray-400 text-xs">$</span>
